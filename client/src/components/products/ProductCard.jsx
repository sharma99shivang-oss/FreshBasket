...
export default function ProductCard({ product }) {
  ...
  onError={(e) => {
    ...
    e.target.src =
      "https://placehold.co/600x400/F97316/FFFFFF?text=FreshBasket";
  }}
/>
